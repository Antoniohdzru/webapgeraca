...
// --- Importación de Datos y Páginas ---
...
const logoUrl = 'img/BANNER_WEB/LogoRaca.png';
      ...
      <Navbar className="navbar-custom sticky-top" expand="lg" variant="dark">
        <Container>
          <Navbar.Brand as={Link} to="/">
            <img src={logoUrl} height="40" alt="Logo RACA Baloncesto" />
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto align-items-center">
              ...
              <div className="d-flex align-items-center">
                ...
                <Nav.Link href="https://www.youtube.com/@CDRaCa" target="_blank" rel="noopener noreferrer" className="social-icon-link"><FaYoutube /></Nav.Link>
              </div>
            </Nav>
          </Navbar.Collapse>
        </Container>
        ...
        <Container>
          <Row>
            <Col md={4} className="mb-4 mb-md-0 text-start">
              <h5 className="footer-title">CD Tear Ramón y Cajal</h5>
              <p>Pabellón Paquillo Fernández<br />C. de Joaquina Eguaras, 11<br />18013, Granada, España</p>
              <p>Tel: +34 606 63 87 23</p>
            </Col>
            <Col md={2} className="mb-3 mb-md-0 text-start">
              <h5 className="footer-title">Club</h5>
              <Nav className="flex-column">
                <Nav.Link as={Link} to="/club" className="footer-link">Nuestro Club</Nav.Link>
                <Nav.Link as={Link} to="/historia" className="footer-link">Historia</Nav.Link>
                <Nav.Link as={Link} to="/cantera" className="footer-link">Cantera</Nav.Link>
              </Nav>
            </Col>
            <Col md={3} className="mb-3 mb-md-0 text-start">
              <h5 className="footer-title">Legal</h5>
              <Nav className="flex-column">
                <Nav.Link as={Link} to="/aviso-legal" className="footer-link">Aviso Legal</Nav.Link>
                <Nav.Link as={Link} to="/privacidad" className="footer-link">Política de Privacidad</Nav.Link>
              </Nav>
            </Col>
            <Col md={3} className="text-md-end">
              <h5 className="footer-title">Síguenos</h5>
              <div className="social-icons-footer">
                <a href="https://www.facebook.com/CDRaca/?locale=es_ES" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer-social-icon me-2"><FaFacebookF size="1.5em"/></a>
                <a href="https://x.com/cdraca" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="footer-social-icon me-2"><FaXTwitter size="1.5em"/></a>
                <a href="https://www.instagram.com/cdraca/?hl=es" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer-social-icon me-2"><FaInstagram size="1.5em"/></a>
                <a href="#" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="footer-social-icon"><FaYoutube size="1.5em"/></a>
              </div>
            </Col>
          </Row>
          <hr className="mt-4 mb-3 footer-hr" />
          <p className="text-center text-muted-footer mb-0">
            © {new Date().getFullYear()} CD TEAR RAMÓN Y CAJAL. Todos los derechos reservados.
          </p>
        </Container>
      </footer>
    </div>
