// src/data/noticiasData.js (VERSIÓN CORREGIDA)
...
export const todasLasNoticias = [
  ...
  { 
    id: 'nuevas-alianzas',
    img: '/news-2.jpg', 
    title: 'Nuevas alianzas para la cantera', 
    text: 'El club firma acuerdos con dos nuevos colegios para expandir sus escuelas deportivas.',
    externalLink: '#'
  },
  { 
    id: 'laura-arrojo-referente',
    img: '/news-3.jpg', 
    title: 'Laura Arrojo, un referente', 
    text: 'La trayectoria de nuestra canterana, compaginando medicina y baloncesto, inspira a las nuevas generaciones.',
    externalLink: '#'
  },
  { 
    id: 'nueva-equipacion',
    img: '/news-4.jpg', 
    title: 'Presentada la nueva equipación', 
    text: 'Descubre los detalles y el diseño de la nueva piel que vestirá a todos nuestros equipos.',
    externalLink: '#'
  },
  { 
    id: 'campus-verano',
    img: '/news-5.jpg', 
    title: 'Comienzan los Campus de Verano', 
    text: 'Arrancan los campus de tecnificación y lúdicos para que la diversión no pare en vacaciones.',
    externalLink: '#'
  },
];
